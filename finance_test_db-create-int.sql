...
----------------------------
CREATE TABLE IF NOT EXISTS int.t_validation_amount_date(
...
SELECT setval('int.t_validation_amount_date_validation_id_seq', (SELECT MAX(validation_id) FROM int.t_validation_amount_date) + 1);
